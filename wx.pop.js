define(['wx.config','wx.tpl','wx.validator'],function(config,wx){
  ...
  Dialog.prototype.resize = function(){
    var window_width = $(window).width(),
        window_height = document.documentElement.scrollHeight || document.body.scrollHeight;
  ...
  Dialog.prototype.toCenter = function(){
    ...
    if(~~this.$body.css('top').slice(0,-2) + ~~this.$body.css('margin-top').slice(0,-2) < 40)
      this.$body.css('margin-top','-100px');
  }
